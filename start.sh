...
while true; do
    ...
    case "$option" in
        ...
        3)
            ...
            cd core/portainer && docker-compose down > /dev/null 2>&1 && cd ../..
            cd core/database && docker-compose down > /dev/null 2>&1 && cd ../..
            cd core/proxy && docker-compose down > /dev/null 2>&1 && cd ../..
